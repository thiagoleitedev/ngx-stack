...
import { NgxUiService, NgxFormConfig, CardConfig } from '@ngx-plus/ngx-ui'
...
export class UserPasswordComponent implements OnInit {
  ...
  constructor(public service: UsersService, public ui: NgxUiService, private router: Router) {}

  ngOnInit() {
    this.subscriptions = []
    this.subscriptions.push(this.service.selected$.subscribe(user => (this.item = user), err => console.log(err)))
    this.formConfig = {
      fields: {
        password: 'password',
        confirm: {
        ...
        return this.service.changePassword(
          ...
          res =>
            this.ui.alerts.notifySuccess({
              ...
              body: `<u>${event.payload.email}</u>'s password has been changed successfully'`,
            }),
          err =>
        ...
        return this.service.resetPassword(
          ...
          res =>
            this.ui.alerts.notifySuccess({
              ...
              body: `An email with a password recovery link has been sent to <u>${event.payload.email}</u>`,
            }),
          err =>
            this.ui.alerts.notifyError({
