...
import { ACL, ACLApi, Role, SDKModels } from '@ngx-plus/ngx-sdk'
...
export class ControlsService {
  ...
  private modelOptions = [{ label: '*', value: '*' }]
  ...
  constructor(private api: ACLApi, private models: SDKModels, private store: Store<any>) {
    ...
    Object.keys(this.models.getAll()).forEach(model => {
