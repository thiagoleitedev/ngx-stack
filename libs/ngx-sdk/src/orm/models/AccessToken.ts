...
import { AccessToken, AccessTokenInterface, LoopBackFilter } from '../../models';
import { AccessTokenActions } from '../../actions';

export class OrmAccessToken extends OrmBase<AccessToken | AccessTokenInterface> {
  constructor(protected store: Store<AccessToken>, protected realTime?: RealTime) {
    super(store, AccessToken, AccessTokenActions, realTime);
  }
