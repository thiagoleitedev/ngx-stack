...
export class AccountEffects extends BaseLoopbackEffects {
  ...
  public findByIdRoles$ = this.actions$
    .ofType(AccountActionTypes.FIND_BY_ID_ROLES).pipe(
      mergeMap((action: LoopbackAction) =>
        this.account.findByIdRoles(action.payload.id, action.payload.fk).pipe(
          mergeMap((response: any) => concat(
  ...
  public destroyByIdRoles$ = this.actions$
    .ofType(AccountActionTypes.DESTROY_BY_ID_ROLES).pipe(
      mergeMap((action: LoopbackAction) =>
        this.account.destroyByIdRoles(action.payload.id, action.payload.fk).pipe(
          mergeMap((response: any) => concat(
  ...
  public updateByIdRoles$ = this.actions$
    .ofType(AccountActionTypes.UPDATE_BY_ID_ROLES).pipe(
      mergeMap((action: LoopbackAction) =>
        this.account.updateByIdRoles(action.payload.id, action.payload.fk, action.payload.data).pipe(
          mergeMap((response: any) => concat(
            resolver({id: action.payload.id, data: response, meta: action.meta}, 'Role', 'findByIdSuccess'),
  ...
  public linkRoles$ = this.actions$
    .ofType(AccountActionTypes.LINK_ROLES).pipe(
      mergeMap((action: LoopbackAction) =>
        this.account.linkRoles(action.payload.id, action.payload.fk, action.payload.data).pipe(
          mergeMap((response: any) => concat(
          of(new actions['RoleMappingActions'].createSuccess(response, action.meta)),
          of(new AccountActions.linkRolesSuccess(action.payload.id, response, action.meta))
        )),
          catchError((error: any) => concat(
  ...
  public unlinkRoles$ = this.actions$
    .ofType(AccountActionTypes.UNLINK_ROLES).pipe(
      mergeMap((action: LoopbackAction) =>
        this.account.unlinkRoles(action.payload.id, action.payload.fk).pipe(
          mergeMap((response: any) => concat(
          of(new actions['RoleMappingActions'].deleteByIdSuccess(response.id, action.meta)),
          of(new AccountActions.unlinkRolesSuccess(action.payload.id, response, action.meta))
        )),
          catchError((error: any) => concat(
  ...
  public getRoles$ = this.actions$
    .ofType(AccountActionTypes.GET_ROLES).pipe(
      mergeMap((action: LoopbackAction) =>
        this.account.getRoles(action.payload.id, action.payload.filter).pipe(
          mergeMap((response: any) => concat(
  ...
  public createRoles$ = this.actions$
    .ofType(AccountActionTypes.CREATE_ROLES).pipe(
      mergeMap((action: LoopbackAction) =>
        this.account.createRoles(action.payload.id, action.payload.data).pipe(
          mergeMap((response: any) => concat(
            resolver({data: response, meta: action.meta}, 'Role', 'findSuccess'),
  ...
  public deleteRoles$ = this.actions$
    .ofType(AccountActionTypes.DELETE_ROLES).pipe(
      mergeMap((action: LoopbackAction) =>
        this.account.deleteRoles(action.payload.id).pipe(
  ...
  public createManyRoles$ = this.actions$
    .ofType(AccountActionTypes.CREATE_MANY_ROLES).pipe(
      mergeMap((action: LoopbackAction) =>
        this.account.createManyRoles(action.payload.id, action.payload.data).pipe(
          mergeMap((response: any) => concat(
            resolver({data: response, meta: action.meta}, 'Role', 'findSuccess'),
